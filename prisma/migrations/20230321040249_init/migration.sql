/*
  ...
  - A unique constraint covering the columns `[locationId]` on the table `Team` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Team_locationId_key" ON "Team"("locationId");
