...
<Calendar.Root let:months let:weekdays weekdayFormat="short" class={cn('p-3', className)}>
	<Calendar.Header class="flex justify-between pt-1 relative items-center w-full">
		<Calendar.PrevButton
			class={cn(
	...
	<div class="flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 mt-4">
